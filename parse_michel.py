...
OUTDIR = "/cluster/kappa/90-days-archive/wongjiradlab/larbys/data/db/rse/parse_michel/%s/" % SAMPLE
...
for flist in get_stage1_flist(SAMPLE,IS_MC):
    ...
    SS += "&& "
    SS += "python /usr/local/share/dllee_unified/larlite/UserDev/RecoTool/MichelStudy/mac/run_michel_study.py %s %s %s 1>/dev/null 2>/dev/null\""
